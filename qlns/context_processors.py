...
def giaichi_chuaduyet(request):
    ...
    if usercheck:
        ...
        if nvcv.tencongviec=="TP":
            ...
            gc_sep_cd_pb = Giaichi.objects.filter(trangthaiduyet_tp=True,trangthaiduyet_sep=False,phongban=nvcv.phongban,trangthaihuy=False) 
        ...
        if nvcv.tencongviec == "SEP":
            ...
            gc_sep_cd = Giaichi.objects.filter(trangthaiduyet_tp=True,trangthaiduyet_sep=False,trangthaihuy=False) 
