...
urlpatterns = [
    ...
    path('nhan-vien/de-xuat/<int:dexuat_id>', Xulyduyet_tp.as_view(), name='xu-ly-duyet-tp'),
    path('nhan-vien/de-xuat/duyet-de-xuat/<int:dexuat_id>', Xulyduyet_sep.as_view(), name='xu-ly-duyet-sep'),
    ...
    path('nhan-vien/de-xuat/xem-de-xuat/<int:dexuat_id>',View_dexuat.as_view(),name='view-dexuat'),
    path('nhan-vien/de-xuat/sua-de-xuat/<int:dexuat_id>',Editdexuat.as_view(),name='edit-dexuat'),
    ...
    path('nhan-vien/quan-ly-giai-chi/form-da-tam-ung/<int:dexuat_id>',Formnhap_tamung.as_view(),name='form-nhap-tam-ung'),
    ...
    path('nhan-vien/giai-chi/tao-giai-chi-tu-de-xuat/<int:dexuat_id>',Giaichi_dx.as_view(),name='tao-giai-chi-dx'),
    ...
    path('nhan-vien/giai-chi/view-giai-chi/<int:giaichi_id>',View_giaichi.as_view(),name='view-giai-chi'),
    path('nhan-vien/giai-chi/edit-giai-chi/<int:giaichi_id>',Edit_giaichi.as_view(),name='edit-giai-chi'),
    path('nhan-vien/giai-chi/view-giai-chi-tp/<int:giaichi_id>',View_giaichi_tp.as_view(),name='view-giai-chi-tp'),
    ...
    path('nhan-vien/quan-ly-giai-chi/xu-ly-giai-chi-tp/<int:giaichi_id>',Xu_ly_giai_chi.as_view(),name='xu-ly-giai-chi-tp'),
    path('nhan-vien/quan-ly-giai-chi/xu-ly-giai-chi-sep/<int:giaichi_id>',Xu_ly_giai_chi.as_view(),name='xu-ly-giai-chi-sep'),
    ...
    path('nhan-vien/xem-sach-khach-hang-lon/<int:khachhang_id>',View_khachhanglon.as_view(),name="xem-khach-hang-lon"),
    path('nhan-vien/sua-sach-khach-hang-lon/<int:khachhang_id>',Edit_khachhanglon.as_view(),name="sua-khach-hang-lon"),

    path('nhan-vien/thu-quy/thanh-toan-giai-chi/',Thanhtoan_giaichi.as_view(),name="thanh-toan-giai-chi"),
    path('nhan-vien/thu-quy/thanh-toan-giai-chi/<int:giaichi_id>',Xacnhanthanhtoan_giaichi.as_view(),name="nhap-thanh-toan-giai-chi"),
